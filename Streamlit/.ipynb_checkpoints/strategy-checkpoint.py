...
strategies_sel = st.sidebar.multiselect('Select Strategies', strategies_df['Strategies_id'])

if strategies_sel:
    
    for file in strategies_sel:
        str
    ...
    for strategies in strategies_sel:
        strategy_file = f"{file}"
